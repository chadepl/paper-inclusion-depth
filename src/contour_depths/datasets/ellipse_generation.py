...
def get_ensemble_params(num_members, ellipticities=None, isovalues=None, translations_x=None, translations_y=None,
                        rotations_deg=None, noise_params=None, metadata=None):
    """
