...
from backend.src.datasets.bd_paper import get_contaminated_contour_ensemble_shape, \
    get_contaminated_contour_ensemble_magnitude, get_contaminated_contour_ensemble_center
...
for i, d in enumerate(depths):
    ...
    to_highlight = None
    plot_contour_spaghetti(ensemble, highlight=to_highlight, arr=d, is_arr_categorical=False, vmin=vmin, vmax=vmax,
                           ax=axs[i])
