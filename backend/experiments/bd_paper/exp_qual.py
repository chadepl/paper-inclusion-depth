...
for index, row in df_outs.iterrows():
    ...
    plot_contour_spaghetti([ensemble[i] for i in lab_sort], arr=[labels[i] for i in lab_sort], is_arr_categorical=True, linewidth=5, alpha=0.5, smooth_line=False, ax=ax)
    plt.show()
