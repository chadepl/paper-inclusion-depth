...
if res_path.exists():
    ...
    print("BoD ...")
    t_start = time()
    depths_bod, p_depths, border_coords = border_depth.compute_depths(ensemble, use_fast=True, global_criteria=None, modified=False, return_point_depths=True, return_border_coords=True)
    t_end = time()
    times["bod"] = t_end - t_start

    print("wBoD ...")
    t_start = time()
    depths_wbod, wbod_p_depths, wbod_border_coords = border_depth.compute_depths(ensemble, global_criteria="nestedness", modified=True, return_point_depths=True, return_border_coords=True)
    t_end = time()
