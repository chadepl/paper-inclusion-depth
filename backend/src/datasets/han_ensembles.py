...
def get_han_slice_ensemble(num_rows, num_cols, patient_id=0, structure_name="Parotid_R", slice_num=41):
    ...
    fn = Path(f"/Users/chadepl/git/multimodal-contour-vis/backend/data/han_ensembles/ensemble-{structure_name}-hptc/{patient}/ed_ensemble-v4_size-subsets-31-{structure_name}.npz").resolve()
